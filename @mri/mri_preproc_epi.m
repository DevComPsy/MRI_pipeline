...
matlabbatch{1}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsfile = {[spm('dir') '\toolbox\FieldMap\pm_defaults.m']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\toolbox\FieldMap\pm_defaults.m'};
...
matlabbatch{3}.spm.spatial.preproc.tissue(1).tpm = {[spm('dir') '\tpm\TPM.nii,1']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,1'};
matlabbatch{3}.spm.spatial.preproc.tissue(1).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(1).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(1).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).tpm = {[spm('dir') '\tpm\TPM.nii,2']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,2'};
matlabbatch{3}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{3}.spm.spatial.preproc.tissue(2).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).tpm = {[spm('dir') '\tpm\TPM.nii,3']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,3'};
matlabbatch{3}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{3}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).tpm = {[spm('dir') '\tpm\TPM.nii,4']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,4'};
matlabbatch{3}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{3}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).tpm = {[spm('dir') '\tpm\TPM.nii,5']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,5'};
matlabbatch{3}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{3}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{3}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{3}.spm.spatial.preproc.tissue(6).tpm = {[spm('dir') '\tpm\TPM.nii,6']}; %{'C:\Users\Kenza Kedri\Documents\MATLAB\spm12\tpm\TPM.nii,6'};
...
for i = 1:length(tmp)
    ...
    mri.epis{i} = fullfile(tmp(i).folder, tmp(i).name);
end
